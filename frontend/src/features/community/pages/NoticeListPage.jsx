        ...
        <div className="w-full max-w-7xl">
          ...
          {!showDetail ? (
            <BoardList
              ...
              onRefresh={() => fetchBoards('', '', 'Y')}
              searchKeyword={searchKeyword}
              onSearchInputChange={e => setSearchKeyword(e.target.value)}
              onSearch={() => fetchBoards('', searchKeyword, 'Y')}
              onSearchKeyPress={e => { if (e.key === 'Enter') fetchBoards('', searchKeyword, 'Y'); }}
              onResetSearch={() => { setSearchKeyword(''); fetchBoards('', '', 'Y'); }}
