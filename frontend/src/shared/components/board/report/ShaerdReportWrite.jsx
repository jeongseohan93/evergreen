...
const ShaerdReportWrite = ({
  ...
  <div className="p-5 max-w-7xl mx-auto font-light text-sm text-gray-800">
    <div className="p-5 max-w-7xl mx-auto">
      ...
      <form onSubmit={e => { e.preventDefault(); handleCreate(); }} className="bg-white p-5 rounded-lg border border-[#306f65]">
        <div className="mb-5">
...
export default ShaerdReportWrite;
