...
function Footer() {
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
                ...
                <div className="col-span-2">
                    ...
                    <div className="text-sm leading-relaxed space-y-1">
                        <p>상호명: 에버그린피싱</p>
                        <p>대표자: 윤영미</p>
                        <p className="text-sm">사업자등록번호: 824-58-00315
                        <a href="https://www.ftc.go.kr/bizCommPop.do?wrkr_no=8245800315" target="_blank" rel="noopener noreferrer" className="ml-2 px-2 py-0.5 border border-gray-400 rounded text-xs text-gray-600 hover:text-blue-600 hover:border-blue-500">사업자정보확인</a>
                        </p>
  ...
  개인정보책임관리자 : 윤영미 (
  <a
    href="mailto:egfisning@naver.com"
    className="text-black-600 hover:underline text-bold"
  >
    egfisning@naver.com
  </a>
  )
                ...
                <div className="col-span-1 pl-8">
                    ...
                    <ul className="space-y-2 text-sm mb-6">
                        {footerLinks.map((link, index) => {
                            return (
                                <li key={index}> {/* React에서 리스트 렌더링 시 key prop은 필수입니다. */}
